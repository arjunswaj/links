package org.iiitb.se.links.utils.network.groups;
...
public class GroupTimelineLoader extends AbstractResourceDownloader {

  protected static final String TAG = "GroupTimelineLoader";
  private BookmarksAdapter bookmarksAdapter;
  private List<JSONObject> bookmarks;
  private String groupId;

  public GroupTimelineLoader(Context context,
            ...
            try {
              ...
              if (0 < bookmarks.size()) {
                ...
                sharedPreferencesEditor.putString(
                    AppConstants.GROUPS_FIRST_BOOKMARK_UPDATED_AT, updatedAt);

                linkObj = bookmarks.get(bookmarks.size() - 1);
                updatedAt = linkObj.getString(StringConstants.UPDATED_AT);
                sharedPreferencesEditor.putString(
                    AppConstants.GROUPS_LAST_BOOKMARK_UPDATED_AT, updatedAt);
