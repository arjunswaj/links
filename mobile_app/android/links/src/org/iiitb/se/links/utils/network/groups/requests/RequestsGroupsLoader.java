...
public class RequestsGroupsLoader extends AbstractResourceDownloader {

  protected static final String TAG = "RequestsGroupsLoader";
  protected RequestsGroupsAdapter groupsAdapter;
  protected List<JSONObject> groups;

  public RequestsGroupsLoader(Context context,
      RequestsGroupsAdapter groupsAdapter, List<JSONObject> groups) {
    super(context);
  ...
  public void authorizeOrLoadGroups() {
    ...
    if (null == accessTokenKey || null == accessTokenSecret) {
      ...
      Log.i(TAG,
          "Token Key found. Will access protected resource - requests groups.");
          ...
          if (null == responseBody || 401 == status) {
            ...
            try {
              ...
              if (0 < groups.size()) {
                ...
                Log.i(TAG, "Fetched the Requests Groups");
              }
